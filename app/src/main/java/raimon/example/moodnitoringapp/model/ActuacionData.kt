...
object ActuacionData {
    val actuacionDatos = listOf(
        Actuacion(1, "La depresion", "La depresión es un trastorno mental caracterizado fundamentalmente por un bajo estado de ánimo y sentimientos de tristeza, asociados a alteraciones del comportamiento, del grado de actividad y del pensamiento.\n" +
                "\n" +
